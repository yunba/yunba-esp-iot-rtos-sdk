...
#if defined(PRO_SMART_PLUG)
#define PLUG_KEY_0_IO_MUX     	PERIPHS_IO_MUX_MTCK_U
#define PLUG_KEY_0_IO_NUM     	13
#define PLUG_KEY_0_IO_FUNC    	FUNC_GPIO13

#define PLUG_RELAY_LED_IO_MUX   PERIPHS_IO_MUX_MTMS_U
#define PLUG_RELAY_LED_IO_NUM   14
#define PLUG_RELAY_LED_IO_FUNC  FUNC_GPIO14
#else
#define PLUG_KEY_0_IO_MUX     PERIPHS_IO_MUX_MTMS_U
#define PLUG_KEY_0_IO_NUM     14
#define PLUG_KEY_0_IO_FUNC    FUNC_GPIO14

#define PLUG_RELAY_LED_IO_MUX     PERIPHS_IO_MUX_MTDI_U
#define PLUG_RELAY_LED_IO_NUM     12
#define PLUG_RELAY_LED_IO_FUNC    FUNC_GPIO12
#endif
